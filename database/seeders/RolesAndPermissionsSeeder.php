...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::creat(['name' => 'assing ticket']);
        ...
        $role = Role::create(['name' => 'moderator'])
            ->givePermissionTo(['access dashboard', 'view users', 'view suspensions', 'edit users', 'delete users', 'view page', 'add page component', 'edit page component', 'delete page component', 'view pages controller', 'add page controller', 'edit page controller', 'delete page controller', 'view reports', 'view policies', 'create policy', 'edit policy', 'delete policy', 'suspend', 'close report', 'send ticket message', 'update tickets', 'assing ticket']);

        $role = Role::create(['name' => 'support'])
            ->givePermissionTo(['access dashboard', 'view tickets', 'view suspensions', 'view reports', 'suspend', 'view policies', 'close report', 'send ticket message', 'update tickets', 'assing ticket']);
